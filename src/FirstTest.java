...
public class FirstTest {
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("app", "/Users/administrator/Desktop/newJavaAppiumAutomation/apks/org.wikipedia.apk");
  ...
  /*
    ...
    public void saveTwoArticleMyList()
    {
       ...
       waitForElementPresent( By.id("org.wikipedia:id/view_page_title_text"),
        ...
        waitForElementAndClick(
                By.xpath("//*[@resource-id='org.wikipedia:id/item_container']//*[@resource-id='org.wikipedia:id/item_title'][@text='" + name_of_folder + "']"),
...
driver.runAppInBackground(2);
    ...
    public void testChangeScreenOrientationOnSearchResults()
    {
        ...
        waitForElementAndClick(
                By.xpath("//*[@resource-id='org.wikipedia:id/page_list_item_container']//*[@text='Object-oriented programming language']"),
                "Cannot find 'Object-oriented programming language' topic search by' topic searching by" + search_line,
                15
        );
...
int amount_of_search_results = getAmountElements(By.xpath(search_result_locator));
    ...
    @Test
    public void saveFirstArticleMyList()
    {
        waitForElementAndClick(
                By.xpath("//*[contains(@text, 'Search Wikipedia')]"),
                "Cannot find search Wikipedia input",
...
waitForElementNotPresent(
    ...
    public void testSwipeArticle()
    {
        ...
        waitForElementAndClick(
                ...
                "Cannot find search Appium in search",
                5
        ...
        swipeUpToFindElement(
               ...
               "Cannot find the end ot the article",
                20
                 );
    ...
    public void testCancelSearch()
    {
        ...
        waitForElementAndSendKeys(
         ...
         WebElement test =    waitForElementPresent(
    ...
    public void testSearchTitle()
    {
        ...
        WebElement title_element =  waitForElementPresent( By.xpath("//*[contains(@text, 'Search…')]"),

...
abstract public class ArticlePageObject extends MainPageObject {
    ...
    public void swipeToFooter() {
        ...
        if (Platform.getInstance().isAndroid()){
            ...
            this.swipeUpToFindElement(FOOTER_ELEMENT, "Cannot find the end ot the article", 40);
        } else {

            this.swipeUpTitleElementAppear(FOOTER_ELEMENT, "Cannot find the end ot the article", 40);
    ...
    public void addArticleToMyListToFooter() {
        ...
        this.waitForElementAndClick(ADD_TO_FOOTER_ELEMENT,
                "Cannot find it tip overlay",
                5
